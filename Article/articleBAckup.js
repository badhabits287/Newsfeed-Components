...
const data = [
  ...
  */
  ...
  articleButton.appendChild(btnClose);
    ...
    articleDate.classList.add("date");
    articlesBdy.classList.add('firstParagraph')
    articlesBdy.classList.add('secondParagraph')
    articlesBdy.classList.add('thirdParagraph')
    ...
    btnClose.textContent = close;
      ...
      // articleFirstP.innerText = firstParagraph;
      // articlesecondP.innerText = secondParagraph;
    thirdP.innerText = thirdParagraph;
    //style
   ...
   articleButton.addEventListener('click', () => {
    ...
    article.classList.toggle("articles");
   
    articleButton.classList.toggle('btn')
  ...
  data.push({
      ...
      secondParagraph: "Even tho it was hard ",
