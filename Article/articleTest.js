...
const data = [
  ...
  */
  ...
  const createArticle = (title, date, firstParagraph, secondParagraph, thirdParagraph) => {
    ...
    articleContainer.appendChild(pContainer);
  
    pContainer.appendChild(paragraph1);
    pContainer.appendChild(paragraph2);
    pContainer.appendChild(paragraph3);
    ...
    articleButton.classList.add('article-buttons')
      btnOpen.classList.add('article-btn-open')
      btnClose.classList.add('article-btn-close', )
